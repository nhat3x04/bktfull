...
<link rel="alternate" type="application/rss+xml" title="AT10 FOOD &raquo; NHO XANH Dòng phản hồi" href="https://at10.mediawz.com/san-pham/nho-xanh/feed/" />
...
<body data-rsssl=1 class="product-template-default single single-product postid-98 wp-custom-logo theme-halinkat10 woocommerce woocommerce-page woocommerce-no-js has-header-image has-sidebar colors-light">
<script>
	...
	<div class="breadcrumb-content">
		...
		<div class="wrapper">
			<div class="inner text-center">
				<div class="breadcrumb-big"><h2>{{ $food->name }}</h2></div>
				<div class="breadcrumb-small">
                	<p id="breadcrumbs"><span><span><a href="http://at10.chonweb.vn/">Trang chủ</a> » <span><a href="http://at10.chonweb.vn/san-pham/">Sản phẩm</a> » <span class="breadcrumb_last" aria-current="page">{{ $food->name }}</span></span></span></span></p>				</div>
			</div>
		</div>
	</div>
</section>    
...
<div class="product-size-hotline" style="margin-bottom:10px;">
	<div class="product-hotline" style="display:inline-block;">
		<svg class="svg-inline--fa fa-phone fa-w-16" aria-hidden="true" data-prefix="fa" data-icon="phone" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M493.397 24.615l-104-23.997c-11.314-2.611-22.879 3.252-27.456 13.931l-48 111.997a24 24 0 0 0 6.862 28.029l60.617 49.596c-35.973 76.675-98.938 140.508-177.249 177.248l-49.596-60.616a24 24 0 0 0-28.029-6.862l-111.997 48C3.873 366.516-1.994 378.08.618 389.397l23.997 104C27.109 504.204 36.748 512 48 512c256.087 0 464-207.532 464-464 0-11.176-7.714-20.873-18.603-23.385z"></path></svg><!-- <i class="fa fa-phone" aria-hidden="true"></i> --> Hotline hỗ trợ 24/7: <a href="tel:0327256830"> 0327256830</a>
    </div><span> | </span><div class="social-network-actions text-left">
    	<div class="fb-like" data-href="https://at10.mediawz.com/san-pham/nho-xanh/" data-width="" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
    </div>
</div>
	...
	<form class="cart" action="https://at10.mediawz.com/san-pham/nho-xanh/" method="post" enctype='multipart/form-data'>
			...
			<div class="quantity">
				<label class="screen-reader-text" for="quantity_664c5f08acb3f">{{ $food->name }} số lượng</label>
		<input
			type="number"
			id="quantity_664c5f08acb3f"
...
<div class="product_meta">
		...
		<span class="sku_wrapper">Mã: <span class="sku">MSP-{{ $food->id }}</span></span>
	...
	<div class="product-item" style="min-height:255px;" >
        ...
        <div class="product-info">
            ...
            <div class="product-actions text-center clearfix">
                <a href="https://at10.mediawz.com/san-pham/nho-xanh/">
                    <a type="button" style="background:green" class="btn btn-primary btn-buyNow buy-now medium--hide small--hide" data-id="1026777806" href="{{ route('foods.show', ['food' => $food->id]) }}" role="button">Chi tiết</a>
                </a>
            </div>
        </div>
    </div>
...
<li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn mua hàng</a></li>
					...
					<h3 class="footer-title">GALLERY</h3>					<div class="grid gallery-wrapper mg-left-15">
                                ...
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c5f08bad2f" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c5f08bad2f" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery664c5f08bad2f" data-caption="gallery 1">
