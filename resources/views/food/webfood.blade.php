...
<div id="page" class="site">
	...
	<div class="inner">
                ...
                <div id="hc-search-wrapper" class="hc-search-wrapper">
                    ...
                    <div class="search-bar-header">
                    	<div class="search-form-wrapper">
                        	<form id="searchauto" method="post"  class="searchform-categoris ultimate-search"  action="{{ route('foods.search') }}" >
                            @csrf
                                <div class="wpo-search">
                                    <div class="wpo-search-inner">
                                        <div class="input-group">
                                            <input type="text" name="query" id="searchtext" class="form-control input-search" placeholder="Tìm kiếm trái cây &hellip;" value="{{ old('query', request('query')) }}" style="width:99%;"/>
                                            <span class="input-group-btn">
                                                <button type="submit" style="margin-left: -50px;"id="searchsubmit"><svg class="svg-inline--fa fa-search fa-w-16" aria-hidden="true" data-prefix="fa" data-icon="search" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
        ...
        <!-- <div class="col-md-6">
        <form action="{{ route('foods.search') }}" method="POST" class="form-inline">
        @csrf
            <input type="text" name="query" class="form-control mr-2" placeholder="Tìm kiếm trái cây" value="{{ old('query', request('query')) }}">
